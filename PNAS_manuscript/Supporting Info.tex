...
\begin{table}[]
\centering
\caption{\footnotesize{Summary paleointensity result statistics at site-level, region-level, and overall arithmetic means. The statistics names are the same as in Table \ref{tab:PINT_result}}. n represents the total number of specimen- or site-level results used for calculating mean values. inc$_{tc}$ is the tilt corrected mean inclination. Site-level means for AX6, AX8, AX10, AX11, AX12, AX13, AX16 are calculated based on specimen results. Regional means for Carlton Peak, Kennedy Creek, and Silver Bay are calculated by grouping specimen results from AX6 and AX8 and AX10, AX11 and AX13, AX12 and AX16, respectively. Overall site mean values are calculated using all site level results in this table. Overall region mean values are calculated using all regional mean results in this table. }
\begin{tabular}{cccccccccc}
Group               & B$_{anc}$ & n  & FRAC & GAP-MAX & MAD ($^\circ$) & DANG ($^\circ$) & inc$_{tc}$ & $\gamma$ & VDM (ZAm$^2$) \\
AX6                 & 30.33     & 3  & 0.69 & 0.13    & 3.55           & 2.66            & 38.9       & 2.63     & 48.76         \\
...
Carlton Peak        & 43.18     & 9  & 0.68 & 0.17    & 4.27           & 2.32            & 38.6       & 5.34     & 69.57         \\
Kennedy Creek       & 74.98     & 14 & 0.7  & 0.2     & 4.78           & 1.74            & 35.15      & 5.81     & 124.51        \\
Silver Bay          & 42.02     & 17 & 0.71 & 0.2     & 3.86           & 2.16            & 51.32      & 4.68     & 59.43         \\
overall site mean   & 51.68     &    &      &         &                &                 &            &          & 81.84         \\
overall region mean & 53.39     &    &      &         &                &                 &            &          & 84.5         
\end{tabular}
\end{table}
